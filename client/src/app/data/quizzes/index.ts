...
import { svmQuestions } from './svm';

export type AlgorithmType = 'decision-tree' | 'naive-bayes' | 'k-means' | 'knn' | 'random-forest' | 'adaboost' | 'dbscan' | 'linear-regression' | 'logistic-regression' | 'svm';
...
export const quizData: Record<AlgorithmType, {
  ...
  'svm': {
    ...
    title: 'Support Vector Machine Quiz'
  }
}; 